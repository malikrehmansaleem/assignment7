...
var upperCase = "THE MUHAMMAD ALI JINNAH";
var lowerCase = "tHE muhammad ali jinnah";
var titleCase = "The Muhammad Ali Jinnah";
...
//Author C. Clarke
var famousQuote = '"Any sufficiently advance technology is indistinguishable form magic".';
...
var famous_person = "C. clarke";
var massege = " Any sufficiently advance technology is indistinguishable from magic.";
...
var message = "My Name is Rehman, Current Date = 16-03-2023";
console.log(message);
//program two
//this two code is just add comments.
var num = 15;
...
var names = ["Ali", "Irfan", "amir", "hassan", "musa"];
...
var greeting = ["Ali", "Irfan", "amir", "hassan", "musa"];
...
var car = ["Honda Civic", "toyota Carmry", "mazda 3 turbo", "tesla electric car", "kia forte"];
...
var livingGuestFriend = ["Ali", "Irfan", "amir", "hassan", "Kashif"];
...
var livingGuestFriendOne = ["Ali", "Irfan", "amir", "hassan", "Kashif"];
var replaceGuestFreind = "ahmad";
...
var livingNewFriend = ["Touqeer", "Mazhar", "Faisal"];
for (let i = 0; i < 3; i++) {
...
var moreGuest = ["Ali", "Irfan", "Kashif"];
...
var inviteOnDinner = ["ali", "irfan", "ahmad"];
...
var nameOfCountries = ["Pakistan", "India", "Afghanistan", "China", "Sri Lanka"];
...
var num = 20;
console.log("Equality", num == 20);
console.log("Inequality", num != 20);
